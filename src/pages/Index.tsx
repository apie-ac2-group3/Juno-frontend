        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              Life moves fast, and feelings often go unspoken. Juno is here to
              help you explore them. As your personal AI journaling companion,
              Juno helps you track your moods, spot patterns, and gently guide
              you toward greater self-awareness.
            </p>
            <Button
              asChild
              className="bg-[#8766B4] hover:bg-[#8766B4]/90 text-white px-8 py-3 text-lg"
            >
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-12">
            ...
            <p className="text-muted-foreground">
              Our platform offers a supportive space to help you reflect,
              understand your emotions, and stay connected with professional
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-[#ECAD61] p-6 rounded-3xl">
              ...
              <p className="text-white/90 mb-4">
                A space to reflect—just like this
              </p>
              <div className="bg-white p-4 rounded-xl mb-4">
                ...
                <p className="text-xs text-muted-foreground">
                  Today felt like ups and downs—both was confusing at times, but
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      ...
                      space. Our daily journaling feature helps you process
                      emotions, track personal growth, and develop deeper
              ...
              <Dialog>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Visualize your emotional patterns with our intuitive mood
